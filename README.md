...
- **GPS coordinates display**: _To allow the user to know its current location at all times whenever the location services and permissions are activated/granted._
