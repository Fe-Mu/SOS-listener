...
1. Search for the "Releases" in the column on the right side of the page and download the newest/latest App release in the official GitHub Website/Repository --> https://github.com/Fe-Mu/SoS-Listener/releases
