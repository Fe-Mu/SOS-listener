...
"""
        ...
        s6_how_to_lbl = Label(text=howto.txt_how_to
                              , color='grey'
                              , size_hint_y=None
                              , valign='top'
                              , halign='left'
        ...
        s6_how_to_lbl.bind(texture_size=lambda instance, value: setattr(instance, 'height', value[1]))
        s6_how_to_lbl.bind(width=lambda instance, value: setattr(instance, 'text_size', (value, None)))
        ...
        s6_layout.add_widget(s6_how_to_lbl)
...
The packages/licenses 1 to 9 were directly installed/used by the Developer during the creation of this App. The packages/licenses 10 to 33 were installed automatically during the installation of packages/licenses 1 to 9.
...
"""
    ...
    def show_popup(self, instance):
        ...
        self.txt_input_country = TextInput(hint_text='Enter country code: e.g. 55'
                                           , font_size='15dp'
                                           , border=(4, 4, 4, 4)
                                           , multiline=False
                                           , background_color='lightgrey'
    ...
    def send_sos(self, instance):
        ...
        if self.store.exists(name):
            ...
            sms.send(recipient="+" + self.store[name]['country'] + self.store[name]['telephone']
                     ,
                     message='--Emergency-SOS--\nI need help! please call back as soon as possible, if i dont answer please send help to my location!'
                     )
    ...
    # Manages the EULA accept
    def accept_eula(self, *args):
        self.store2.put("eula", granted="yes")
        self.store2.put("permissions", granted="yes")
        self.sm.current = ('s1')
