...
"""
    ...
    def on_resume(self):
        ...
        restore_lbl = Label(text="\nNew emergency-contacts have been imported. Please close this App and restart it again in order for the changes to take effect."
                            , size_hint_y=None
                            , valign='top'
                            , halign='left'
                            , markup=True
        ...
        # Added by L.F.G Muñoz
        # Setting the label's height with adaptive width
        restore_lbl.bind(texture_size=lambda instance, value: setattr(instance, 'height', value[1]))
        restore_lbl.bind(width=lambda instance, value: setattr(instance, 'text_size', (value, None)))
    ...
    """From the antorix/KivyLoadSave GitHub repository found in: https://github.com/antorix/KivyLoadSave/tree/main"""
    # Changed name of method from 'save_file' to 'backup_contacts' by L.F.G. Muñoz
    def backup_contacts(self,*args):

        """ Save the contacts to device's Documents folder """

        # Added by L.F.G Muñoz
        backup_lbl = Label(text="A backup of all your emergency-contacts has been saved in the /SoS-Listener folder inside the system's /Documents folder"
                            , size_hint_y=None
                            , valign='top'
                            , halign='left'
                            , markup=True
        ...
        # Added by L.F.G Muñoz
        # Setting the label's height with adaptive width
        backup_lbl.bind(texture_size=lambda instance, value: setattr(instance, 'height', value[1]))
        backup_lbl.bind(width=lambda instance, value: setattr(instance, 'text_size', (value, None)))
        ...
        with open(filename, "w") as file:  # creating the file in a normal way, but again in the private storage
            ...
            # Modified by L.F.G Muñoz to suit App's functionalitiy
