...
"""
    ...
    def show_popup(self, instance):
        ...
        self.colorwheel = ColorWheel(size_hint=(1, 1)
                                     , pos_hint={'center_x': 0.5, 'center_y': 0.5}
                                     )
        self.colorwheel.bind(color=self.on_color)

        self.label_color = Button(text='Pick a color'
                                , font_size='13dp'
                                , color='black'
        ...
        self.layout_colorpicker.add_widget(self.colorwheel)
    ...
    def update_data(self, instance):
        ...
        if self.store.exists(update_name):
            ...
            if self.colorwheel.color == [0, 0, 0, 0]:
