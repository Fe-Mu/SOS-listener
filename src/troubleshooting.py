...
[b]GPS coordinates not being displayed[/b]
    ...
    2. Make sure the GPS on your device is turned ON before starting the App. This can be achieved by toggling ON the Location switch in the phone Settings or by tapping the Location icon on your phone.
    3. Check that your GPS is ON while using the App. This can be achieved by toggling ON the Location switch in the phone Settings or by tapping the Location icon on your phone.
