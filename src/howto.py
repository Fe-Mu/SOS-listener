...
[u]Before a manual App update make sure you first backup your emergency-contacts (see above), since manually updating the App will delete the existing emergency-contacts.[/u]
