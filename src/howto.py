...
txt_how_to_1 = """
[b]Activate/Deactivate the test mode[/b]
...
[b]Send SOS-Message[/b]
    ...
    3. Tap on the "Send SOS" button in the new popup window
    4. An SOS with the following message will be sent:
...
Sending a SOS-Message will share the current Location of the person requesting the help in the form of a link that can be opened on the CoMaps app and the Google Maps app. These apps need to be previously installed in order for the user to be able to open the shared locations there.

    1. It is recommended to open the shared GPS coordinates using the CoMaps link due to CoMaps privacy-respecting orientation, which aligns with SOS-listener principles.
    2. Google Maps links are also considered due to Google Maps popularity and wide adoption across multiple devices and countries.

Disclaimer: The developer of this App has no affiliation or relationship with any of these organizations.
